...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Example: await clerk.signUp.create({ emailAddress: formData.email, password: formData.password });
        ...
        {error && (
          <div className="rounded-md bg-destructive/15 p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-destructive">Registration Error</h3>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full rounded-md border-0 py-2 px-3 text-foreground bg-background ring-1 ring-inset ring-input placeholder:text-muted-foreground focus:ring-2 focus:ring-inset focus:ring-primary"
